      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <header className="space-y-2">
            <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 text-xs font-medium text-white bg-green-500 rounded">Early Access</span>
            </div>
          ...
          <div className="grid sm:grid-cols-1 gap-4">
            ...
            <div className="rounded-lg ring-1 ring-black/5 dark:ring-white/10 bg-white/70 dark:bg-gray-900/40 p-4">
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700 dark:text-gray-300">
                  ...
                  <li>Create and manage custom scenery presets to quickly switch between different configurations for
                      various flight scenarios or performance requirements.
                  </li>
              </ul>
            </div>
          </div>
        ...
        <section className="rounded-lg ring-1 ring-black/5 dark:ring-white/10 bg-white/70 dark:bg-gray-900/40 p-4">
          ...
          <div className="flex flex-col items-center gap-3">
              <a
                  href="https://github.com/Canyon-Wolf/TerraVista/releases"
                  target="_blank"
